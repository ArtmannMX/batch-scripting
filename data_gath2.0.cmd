...
::
::
:: REPORTE AIDA64 ENGINEER (CARACTERISTICA NUEVA - FASE BETA)
::
::
%letter%:\PROGRAMAS\SOPORTE_TECNICO\AIDA64\aida64.exe /R "%letter%:\REPORTES\%user%\%userd%\a64report_%COMPUTERNAME%" /ALL /HTML
echo.
echo.
echo ------
echo Listo!
